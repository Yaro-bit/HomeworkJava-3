// Create an interactive console program that tests the user's understanding of Java primitive data types.
// The program should:
// - Prompt the user to enter the maximum and minimum values of byte, short, int, long.
// - Ask for the number of decimal places for float and double types.
// - Validate correct input for char and boolean values.
// - Repeat the process until the user decides to exit.
// All user inputs should be validated, and success or error messages should be displayed accordingly.
